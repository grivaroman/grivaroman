...
**Backend & full-stack engineer.** I build production systems end to end: Node.js/TypeScript APIs, Postgres schemas, real-time layers, Docker/K8s deploys — plus the React and Flutter clients that consume them.

Most of my work ships to real users in marketplace, casting, streaming and media-generation products.

- 🛠 **Stack:** Node.js · TypeScript · Express · Prisma · PostgreSQL · Redis · Socket.IO · Python · FastAPI · React · Docker · Kubernetes
...
Closed source — described here, not linked.
...
`Node.js · TypeScript · Prisma · PostgreSQL · Redis · gRPC · Docker`
